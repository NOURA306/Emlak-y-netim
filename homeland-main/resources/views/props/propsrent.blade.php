...
@section('content')
    <div class="site-blocks-cover inner-page-cover overlay"
        style="background-image: url({{ asset('assets/images/2.jpg') }});" data-aos="fade">
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                <div class="col-md-10">
                    <h1 class="mb-2">Kiralık Emlaklar</h1>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="property-entry h-100">
                            <a href="{{ route('single.prop', $propsrent->id) }}" class="property-thumbnail">
                                ...
                                <img src="{{ asset('assets/images/' . $propsrent->image . '') }}" alt="Resim"
                                    class="img-fluid">
                            </a>
                            <div class="p-4 property-body">
                                <a href="#" class="property-favorite"><span class="icon-heart-o"></span></a>
                                <h2 class="property-title">
                                    <a href="{{ route('single.prop', $propsrent->id) }}">{{ $propsrent->title }}</a>
                                </h2>
                                ...
                                <strong class="property-price text-primary mb-3 d-block text-success">
                                    {{ number_format($propsrent->price, 0, ',', '.') }}₺
                                </strong>
                                <ul class="property-specs-wrap mb-3 mb-lg-0">
                                    <li>
                                        <span class="property-specs">Yatak Odası</span>
                                        <span class="property-specs-number">{{ $propsrent->beds }}</span>
                                    </li>
                                    <li>
