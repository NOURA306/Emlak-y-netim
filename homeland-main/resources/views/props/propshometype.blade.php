    ...
    <div class="site-blocks-cover inner-page-cover overlay"
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                <div class="col-md-10">
                    <h1 class="mb-2"> {{ $hometype }} Emlaklar 
                    </h1>
                </div>
            </div>
        </div>
                        ...
                        <div class="property-entry h-100">
                            ...
                            <div class="p-4 property-body">
                                ...
                                <span class="property-location d-block mb-3">
                                    ...
                                    {{ $propsByHomeType->location }}
                                </span>
                                <strong class="property-price text-primary mb-3 d-block text-success">
                                    {{ number_format($propsByHomeType->price, 0, ',', '.') }}₺
                                </strong>
                                <ul class="property-specs-wrap mb-3 mb-lg-0">
                                    <li>
                                        <span class="property-specs">Oda sayısı</span>
                                        <span class="property-specs-number">{{ $propsByHomeType->beds }}</span>
                                    </li>
                                    <li>
