...
class AdminsController extends Controller
{
    ...
    public function checkLogin(Request $request)
    {
        ...
        if (auth()->guard('admin')->attempt(['email' => $request->input('email'), 'password' => $request->input('password')], $remember_me)) {
            ...
            return redirect()->back()->with(['error' => 'Giriş yapılırken bir hata oluştu']);
        }
    }
    ...
    public function storeAdmins(AdminStoreRequest $request)
    {
        ...
        if ($storeAdmins) {
            return redirect()->route('admins.display')->with('success', 'Yönetici başarıyla eklendi');
        }
    }
    ...
    public function storeProps(Request $request)
    {
        ...
        if ($storeProps) {
            return redirect()->route('admins.allProps')->with('success', 'Özellikler başarıyla eklendi.');
        }
    }
    ...
    public function storeGallery(Request $request)
    {
        ...
        if (!empty($files)) {
            return redirect()->route('admins.allProps')->with('success_gallery', 'Galeri resimleri başarıyla yüklendi.');
        } else {
            return redirect()->route('admins.allProps')->with('error_gallery', 'Hiç resim yüklenmedi');
        }
    }
    ...
    public function deleteProps($id)
    {
        ...
        if ($deleteProp) {
            return redirect()->route('admins.allProps')->with('delete', 'Mülk başarıyla silindi');
        } else {
            return redirect()->route('admins.allProps')->with('error_delete', 'Mülk silinirken bir hata oluştu');
        }
    }
}
